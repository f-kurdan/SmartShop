...
const CategoriesAdminList = () => {
    ...
    return (
        <HandlerContext.Provider value={onCancelClick}>
            <div className={`${montserrat.className} flex flex-col justify-start items-center px-10 py-14 w-full  rounded-xl borde bg-gray-50 shadow-lg text-gray-700 gap-y-16`}>
