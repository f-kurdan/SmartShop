...
const EntitiyCreationSection = () => {
  ...
  return (
    <HandlerContext.Provider value={handleCancelClick}>
      <div onClick={onClickOutside} className={`${montserrat.className} flex flex-col justify-start items-center px-10 py-14 w-11/12 h-screen ounded-sm borde bg-gray-50 shadow-lg text-gray-700 gap-y-16`}>
