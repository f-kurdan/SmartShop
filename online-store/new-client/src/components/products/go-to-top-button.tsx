...
const GoToTopButton = () => {
  ...
  return (
    <div id='goToTop' className={`transition-all duration-300 bg-black border-2 opacity-0 rounded-full fixed bottom-10 right-16 p-2 hover:outline hover:outline-8 hover:outline-cyan-200`}>
      <Link href='#' >
