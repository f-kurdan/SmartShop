    ...
    return (
        <div>
            ...
            (<div key={category.id} className='ml-2'>
                <input onChange={handleCategoriesChange} className='mr-2 scale-125 hover:cursor-pointer' type="checkbox" name='category' id={category.id.toString()} value={category.name} />
