...
const index = () => {
  ...
  return (
    <div onClick={(e) => onClickOutside(e)} className={`${montserrat.className} flex flex-col justify-center items-center px-10 py-5 my-3 w-11/12 h-screen ounded-sm border border-gray-200 bg-gray-50 shadow-lg text-gray-700 gap-y-16`}>
      ...
      <div className={`fixed z-10 bg-white flex-col ${showCategoryModal? "block" : "hidden"} items-start p-5 rounded-lg shadow-lg w-1/2`}>
        Создание категории
      </div>
