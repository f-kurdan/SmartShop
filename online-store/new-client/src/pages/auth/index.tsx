...
const Login = () => {
  return (
    <div className={`${montserrat.className} flex flex-col gap-10  justify-center items-center px-10 py-5 my-3 w-11/12 ounded-sm border border-gray-200 bg-white shadow-lg rounded-2xl`}>
