      ...
      <div className='flex flex-col w-96 gap-2'>
        ...
        <div className='grid grid-cols-2 gap-2 w-96 text-violet-800 font-medium'>
          <div>
            ...
            <label htmlFor="save" className='hover:cursor-pointer hover:text-violet-400'>Запомнить меня</label>
          </div>
          <div className='text-end hover:cursor-pointer hover:text-violet-400'>
